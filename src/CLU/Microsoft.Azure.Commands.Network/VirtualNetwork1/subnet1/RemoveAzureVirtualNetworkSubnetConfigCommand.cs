...
{
    [Cmdlet(VerbsCommon.Remove, "AzureRmVirtualNetwork1Subnet1Config"), OutputType(typeof(PSVirtualNetwork))]
    [CliCommandAlias("vnet1 subnet1 rm")]
    public class RemoveAzureVirtualNetwork1Subnet1ConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
