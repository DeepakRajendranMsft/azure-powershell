...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmVirtualNetwork1Subnet1"), OutputType(typeof(PSSubnet))]
    [CliCommandAlias("vnet1 subnet1 ls")]
    public class GetAzureVirtualNetwork1Subnet1ConfigCommand : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = false,
