...
{
    [Cmdlet(VerbsCommon.Set, "AzureRmVirtualNetwork1Subnet1", DefaultParameterSetName = "LocalSetByResource"), OutputType(typeof(PSVirtualNetwork))]
    [CliCommandAlias("vnet1 subnet1 set")]
    public class SetAzureVirtualNetwork1Subnet1ConfigCommand : AzureVirtualNetwork1Subnet1ConfigBase
    {
