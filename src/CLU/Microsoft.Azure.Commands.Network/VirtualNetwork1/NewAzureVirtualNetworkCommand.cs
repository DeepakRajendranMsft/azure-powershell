...
{
    [Cmdlet(VerbsCommon.New, "AzureRmVirtualNetwork1"), OutputType(typeof(PSVirtualNetwork))]
    [CliCommandAlias("vnet1 create")]
    public class NewAzureVirtualNetwork1Command : VirtualNetworkBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = true,
