...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmVirtualNetwork1"), OutputType(typeof(PSVirtualNetwork))]
    [CliCommandAlias("vnet1 ls")]
    public class GetAzureVirtualNetwork1Command : VirtualNetworkBaseCmdlet
    {
        [Alias("ResourceName")]
        [Parameter(
            Mandatory = false,
